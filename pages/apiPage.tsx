  ...
  return (
    <section className="mt-12 flex flex-col justify-center items-center">
      <div className="w-[80%] text-base">
        ...
        <div className="mb-6">
          <p>
            Or you can see brief info on specific games by it&apos;s ID. Like <span
        ...
        <div className="mb-6">
          <p>
            Or you can see full info on specific game by it&apos;s ID. Like <span
            className="p-1 border-solid border-[1px] rounded-md border-gray-300 bg-slate-700">
              /api/games/[your_id]
            </span>
          </p>
