    ...
    <MainLayout title={"Home"}>
      ...
      >
          ...
          <div className={stylesMain.glass}>
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-br from-cyan-400 to-fuchsia-300">
              {CONST.SITE_NAME}
                ...
                <p className="text-3xl inline-block">It&apos;s a website to explore gaming world!</p>
              </div>
              <div className="text-base text-lg">
                <p>
                  Hi! My name is Tania Pashkevich and I&apos;m a frontend developer.
                  I created this website as a demo project and to learn NextJS. I really like video games so
                  I decided to make a website about them. Here you can check out different games, read about
                  them and see metacritics score.
                </p>
                <p>
                  I love gaming, I have been playing since I was 8 years old.
                  I have a PS5 and PC, and I love playing games on both platforms.
                  My favorite game series of all time is the Last of Us, this is one of the best games I&apos;ve ever played.
                  The story is so powerful and the characters are so believable.
                  And I am also a big fan of Cyberpunk 2077 and S.T.A.L.K.E.R.
                  I also enjoy indie games, like What Remains of Edith Finch. I like when you can just explore the locations
                  and see the beautiful story unfold before you. I think games like this are so important in the industry
                  because they show that you don&apos;t need to have a huge budget to create something beautiful and
                  captivating.
                </p>
              </div>
              <div className="grid grid-cols-[40%_60%] gap-6">
                <div className="text-base flex flex-col justify-center items-center">
                  ...
                  <p className="text-base text-lg mb-6">Explore more games and find something you like.</p>
                  <Link href="/games/">
                    <a className="text-white bg-gradient-to-br from-purple-600 to-blue-500
        ...
        <div className={styles.controller}>
          <Image src={controller} width={controller.width/2} height={controller.height/2} alt="ps4 controller vector" />
        </div>
        <div className={styles.planet}>
          <Image src={planet} width={planet.width/2} height={planet.height/2} alt="glass planet vector" />
        </div>
      </div>
    </MainLayout>
  )
