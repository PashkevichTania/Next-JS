            ...
            <div className="flex flex-col gap-4 pb-5 border-solid border-b border-gray-200 dark:border-gray-700">
              <div>
                <div className="mb-2 block">
                  <Label htmlFor="title" value="Game title" />
                </div>
                <TextInput id="title" type="text" placeholder="Firewatch" />
              </div>
              <div>
                <div className="mb-2 block">
              ...
              <div className="flex items-center gap-2">
                <Checkbox id="sort_rating" defaultChecked={false} />
                <Label htmlFor="sort_rating">Sort by rating</Label>
              </div>
            </div>
            <div className="p-5">
