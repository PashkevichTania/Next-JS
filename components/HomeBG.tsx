  ...
  return (
    <div className={styles.home_bg_main} id="home_space">
      <div className={styles.bg_container} ref={measuredRef}>
        ...
        <img
          src="/assets/pages/home/space/r1.png"
          style={{ width: r1.width * offsetWidth, height: r1.height * offsetHeight }}
          alt="space-rock"
          className={styles.r1}
        />
        <img
          src="/assets/pages/home/space/r2.png"
          style={{ width: r2.width * offsetWidth, height: r2.height * offsetHeight }}
          alt="space-rock"
          className={styles.r2}
        />
        <img
          src="/assets/pages/home/space/r3.png"
          style={{ width: r3.width * offsetWidth, height: r3.height * offsetHeight }}
          alt="space-rock"
          className={styles.r3}
        />
        <img
          src="/assets/pages/home/space/r4.png"
          style={{ width: r4.width * offsetWidth, height: r4.height * offsetHeight }}
          alt="space-rock"
          className={styles.r4}
        />
        <img
          src="/assets/pages/home/space/r5.png"
          style={{ width: r5.width * offsetWidth, height: r5.height * offsetHeight }}
          alt="space-rock"
          className={styles.r5}
        />
        <img
          src="/assets/pages/home/space/r6.png"
          style={{ width: r6.width * offsetWidth, height: r6.height * offsetHeight }}
          alt="space-rock"
          className={styles.r6}
        />
        <img
          src="/assets/pages/home/space/r7.png"
          style={{ width: r7.width * offsetWidth, height: r7.height * offsetHeight }}
          alt="space-rock"
          className={styles.r7}
        />
        <img
          src="/assets/pages/home/space/l1.png"
          style={{ width: l1.width * offsetWidth, height: l1.height * offsetHeight }}
          alt="space-rock"
          className={styles.l1}
        />
        <img
          src="/assets/pages/home/space/l2.png"
          style={{ width: l2.width * offsetWidth, height: l2.height * offsetHeight }}
          alt="space-rock"
          className={styles.l2}
        />
        <img
          src="/assets/pages/home/space/l3.png"
          style={{ width: l3.width * offsetWidth, height: l3.height * offsetHeight }}
          alt="space-rock"
          className={styles.l3}
        />
        <img
          src="/assets/pages/home/space/l4.png"
          style={{ width: l4.width * offsetWidth, height: l4.height * offsetHeight }}
          alt="space-rock"
          className={styles.l4}
        />
      </div>
