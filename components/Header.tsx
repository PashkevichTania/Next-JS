...
export function Header() {
    ...
    const defaultStyles = "relative block px-3 py-2 transition hover:text-cyan-600 dark:hover:text-cyan-400"
                ...
                <div className="relative flex flex-row justify-between content-center pl-10 pr-10">
                    ...
                    <nav className="pointer-events-auto hidden md:block">
                        <ul className="flex rounded-full bg-white/90 px-4 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
                            ...
                            <li>
                                <Link href="/about/" className={defaultStyles + router.pathname == "/about" ? activeStyles : ""}>
                                    <a  className={defaultStyles + " " + (router.pathname == "/about" ? activeStyles : "")}>
                                        About
                                    </a>
                                </Link>
                            </li>
                            <li>
                                <Link href="/games/" className={defaultStyles + router.pathname == "/games" ? activeStyles : ""}>
                                    <a  className={defaultStyles + " " + (router.pathname == "/games" ? activeStyles : "")}>
                                        Games
                                    </a>
                                </Link>
                            </li>
                    ...
                    <div className="flex">
                        <div className="pointer-events-auto">
                            <button type="button" aria-label="Toggle dark mode"
                                ...
                                <svg viewBox="0 0 24 24" strokeWidth="1.5" strokeLinecap="round" stroke-linejoin="round"
                                     aria-hidden="true"
